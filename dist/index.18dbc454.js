...
itemsHtml.forEach((item)=>{
    ...
    const cardPrice = parseFloat(item.querySelector(".card-price > span").innerHTML);
...
function listView() {
    for(i = 0; i < elements.length; i++)elements[i].style.width = "60%";
}
// fonction pour le Grid View
function gridView() {
    for(i = 0; i < elements.length; i++)elements[i].style.width = "";
}
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1SICI"], "1SICI", "parcelRequire2b12")
